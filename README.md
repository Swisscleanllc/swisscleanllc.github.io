...
3. Safety & Pets
	•	Keep pets secured during cleaning visits.
	•	Clear hazardous areas (wet floors, chemicals, or sharp objects) to ensure safety.

4. Valuables & Personal Items
	•	We are careful, but we recommend securing valuables.
	•	Swiss Clean LLC is not responsible for damage to personal items left out in the open.

5. Cleaning Supplies
	•	We provide all standard cleaning supplies and equipment.
	•	If you prefer specific products, please notify us in advance.

6. Payment
	•	Payment is due after services are completed unless a prearranged agreement is made.
	•	Accepted payment methods: [List your accepted methods – cash, card, Venmo, etc.]
